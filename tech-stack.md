...
- **Hosting / Dağıtım (Deployment):** Netlify AI (GitHub ile doğrudan entegre çalışarak kod değişikliklerini anında CI/CD pipeline'ı ile canlıya alabildiği için tercih edilmiştir).
